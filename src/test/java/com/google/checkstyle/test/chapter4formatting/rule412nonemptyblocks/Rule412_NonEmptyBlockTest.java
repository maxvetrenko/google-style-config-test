...
public class Rule412_NonEmptyBlockTest extends BaseCheckTestSupport{
    ...
    public void emptyTest() throws IOException, Exception {
        ...
        String filePath = builder.getFilePath("Braces");
    ...
    public void emptyTest2() throws IOException, Exception {
        ...
        Configuration checkConfig = builder.getCheckConfig("LeftCurly");
        String filePath = builder.getFilePath("LeftCurlyAnnotations");
    ...
    public void emptyTest3() throws IOException, Exception {
        ...
        Configuration checkConfig = builder.getCheckConfig("LeftCurly");
        String filePath = builder.getFilePath("LeftCurlyMethod");
