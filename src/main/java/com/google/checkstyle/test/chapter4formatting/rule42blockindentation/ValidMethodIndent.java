 ...
 * @author  jrichard
 */
public class ValidMethodIndent extends java.awt.event.MouseAdapter implements java.awt.event.MouseListener {
    
    // ctor with rcurly on same line
    public ValidMethodIndent() {
    }

    private ValidMethodIndent(boolean test) {
        boolean test2 = true;
    ...
    public ValidMethodIndent(int dummy)
    {
    }
